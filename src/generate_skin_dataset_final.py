...
if __name__ == "__main__":
    print("="*60)
    print("KitchenGuard CSM - Dataset Generation")
    print("="*60)
    
    # Generate Skin Detection Dataset
    print("\n[1/2] Generating skin tone dataset...")
    rows = []
    ...
    print("="*60)
    print(f"\nFiles saved to: data/")
    print("  1. skin_detection_dataset.csv - Untuk fair skin detection")
    print("  2. waste_quality_dataset_expanded.csv - Untuk waste classification")
    print("\nNext steps:")
