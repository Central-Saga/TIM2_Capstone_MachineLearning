...
│   ├── generate_skin_dataset.py  # Generator dataset skin detection
│   ├── generate_waste_dataset.py # Generator waste classification
│   ├── train_skin_model.py       # Training skin detection model
│   ├── train_improved_waste_model.py  # Training waste classifier
│   └── preprocess.py             # Text preprocessing
├── data/                         # Generated datasets
│   ├── skin_detection_dataset.csv
...
Output:
- ✓ `data/skin_detection_dataset.csv` - 1000 samples (HAND & FACE)
...
### Skin Detection Dataset (1000 samples)
